...
ЕСКЕРТУ:
- Егер мәтінде мынадай сөздер болса: "сәлем", "салем", "ассалаумағалейкум", "привет", "салам", "қалайсың", "жағдайыңыз қалай", "не істеп жатсың", "рақмет", "рахмет", "күшті" -> БҰЛ МІНДЕТТІ ТҮРДЕ "action": "chat" болуы тиіс. Оны "search" қылып жіберме!
- Егер мәтінде нақты өнім, мекеме немесе E-код сұралса (KFC, Snickers, E471, Bahandi, т.б.) -> БҰЛ "search".
...
ЕГЕР "search" болса:
- "query" өрісіне: сұраудан артық сөздерді ("халал", "харам", "ма", "ме", "ба", "бе", "болады ма", "жеуге рұқсат пе") алып тастап, тек негізгі таза бренд/мекеме атауын қалдыр (мысалы: "Bal DAY халал ма" -> "Bal DAY", "KFC рұқсат па" -> "KFC").
